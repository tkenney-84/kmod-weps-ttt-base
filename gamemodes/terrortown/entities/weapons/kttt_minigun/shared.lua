...
SWEP.EquipMenuData = {											-- The information on the credit menu.
	type = "The Minigun",
	desc = "The terminator successfully emptied a drum of this with no human casualties. You are about to be better than the terminator."
};
...
SWEP.NoSights = true												-- SWEP.NoSights determines whether a player cannot or can use iron sights with this weapon.
