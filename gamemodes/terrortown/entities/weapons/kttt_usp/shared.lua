...
SWEP.Kind = WEAPON_PISTOL											-- SWEP.Kind determines what slot the weapon is to take up.
SWEP.AmmoEnt = "item_ammo_pistol_ttt"									-- SWEP.AmmoEnt determines the ammo pickup that will feed this gun.
