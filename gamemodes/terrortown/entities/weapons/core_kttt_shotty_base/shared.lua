...
function SWEP:InsertShell()
	...
	if self.Owner:Alive() then
		...
		-- Checks if the player still has the weapon equipped. If not, executes statement.
		checkStr = getWeaponClassName(self.Owner:GetActiveWeapon())
		if checkStr != self.Gun then 
