...
SWEP.Icon = "VGUI/ttt/R_Icon_Welrod"

//Serverside Settings\\
if ( SERVER ) then
	AddCSLuaFile( "shared.lua" )
	resource.AddFile("materials/VGUI/ttt/R_Icon_Welrod.vmt")
end
...
local FireSound = Sound ("weapons/welrod_fire.wav");
local ReloadSound = Sound ("weapons/welrod_reload.wav");
SWEP.IronSightsPos 		= Vector (-7.3, -2.5, 5.4)
