...
SWEP.Icon = "vgui/entities/m9k_m79gl.vmt"							-- SWEP.Icon is the path to the icon for the weapon (when investigating bodies and such).
if SERVER then														-- Adds the icon file to the servers resources.
	resource.AddFile("materials/vgui/entities/m9k_m79gl.vmt")
end
...
SWEP.EquipMenuData = {											-- The information on the credit menu.
	type = "M79 Grenade Launcher",
	desc = "The hand-held flying dustbin."
};
