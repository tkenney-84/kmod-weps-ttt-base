...
SWEP.Gun = ("m9k_aw50silent") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "AI AW50 Silenced"		-- Weapon name (Shown on HUD)	
...
SWEP.EquipMenuData = {											-- The information on the credit menu.
	type = "The Silent AWP",
	desc = "Using the same technology the PAYDAY gang used to silence an open cylinder revolver, we were able to silence an anti-material rifle!"
};
