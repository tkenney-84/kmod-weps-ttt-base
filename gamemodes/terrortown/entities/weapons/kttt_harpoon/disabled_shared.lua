...
SWEP.Icon = "vgui/entities/m9k_harpoon.vmt"							-- SWEP.Icon is the path to the icon for the weapon (when investigating bodies and such).
if SERVER then														-- Adds the icon file to the servers resources.
	resource.AddFile("materials/vgui/entities/m9k_harpoon.vmt")
end
...
SWEP.EquipMenuData = {											-- The information on the credit menu.
	type = "The Poon",
	desc = "Only a few of you will understand the necesity of this weapon in this gamemode."
};
